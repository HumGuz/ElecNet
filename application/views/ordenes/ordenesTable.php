...
if(!empty($cmp)){		
	foreach ($cmp as $k => $p) {		
		echo '
			...
			<td width="80px"  class="bold">'.App::folio('OC',$p['id_orden_compra']).'</td>
			...
			<td width="30px" class="opt-td">
		                  ...
		                  <ul class="dropdown-menu pull-right" role="menu">
		                    <li><a href="#" onclick="ord.export('.$p['id_orden_compra'].',\'pdf\')" ><span style="color:#bb0706" class="fa fa-file-pdf-o"></span> Exportar PDF </a></li>		                     
