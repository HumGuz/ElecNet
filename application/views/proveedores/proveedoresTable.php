					...
					<tr>
	                  ...
	                  <td width="30px" class="opt-td">
		                  ...
		                  <ul class="dropdown-menu pull-right" role="menu">
		                    ...
		                    <li><a href="#" data-id_proveedor="'.$s['id_proveedor'].'" data-fn="nuevoProveedor"><span class="fa fa-pencil"></span> Editar </a></li>
		                    '.( $s['borrar'] ? '<li class="divider"></li><li><a href="#" data-id_proveedor="'.$s['id_proveedor'].'" data-fn="borrarProveedor"><span class="fa fa-eraser text-danger"></span> Borrar </a></li>':'' ).'
		                  </ul>
		                </div>
	                  </td>
	                </tr> ';	$x++;		
