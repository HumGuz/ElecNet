<<<<<<< HEAD
<div class="modal fade" id="prd-modal" data-width="800px">
		...
		<form id="nvoPrdFrm" class="nvo">
			<div class="modal-body">
				<div class="row">
					...
					<div class="form-group col-sm-3">
						<label for="clave_secundaria">Clave SAT</label>
					...
					<p class="col-sm-12">
						Información Opcional para mostrar en el ecommerce
					</p>
					...
					<div class="form-group col-sm-3">
						...
						<input type="text" class="form-control number" id="tiempo_garantia" name="tiempo_garantia">
					</div>

					<div class="form-group col-sm-3">
						<label for="id_categoria_padre">Colores</label>
						<select  class="form-control selectpicker " id="colores" name="colores" data-container="body" multiple="multiple">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-success  btn-sm ladda-button" data-style="slide-right">
