<<<<<<< HEAD
<div class="modal fade" id="cmp-modal" data-width="90%">
					...
					<table class="table table-condensed table-bcmpered table-stripped fixed prd-form" id="prdCmpTbl" style="opacity: 0">
						...
						<tfoot>
							<tr>
								...
								<td>
								<input type="text" class="form-control typeahead" id="conc_cmp" />
								</td>
								<td >
								<div class="input-group">
							...
							<tr>
								<td colspan="5" class="right" > Costo de envío: </td>
								<td  class="right bold" id="envio"> $ 0.00 </td>
							</tr>
							<tr>
								<td colspan="5" class="right" > I.V.A.: </td>
