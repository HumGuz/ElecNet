...
if(!empty($cmp)){		
	foreach ($cmp as $k => $p) {		
		echo '
			...
			<td width="80px"  class="bold">'.App::folio('CM',$p['id_compra']).'</td>
			...
			<td width="30px" class="opt-td">
		                  ...
		                  <ul class="dropdown-menu pull-right" role="menu">
		                    <li><a href="#" onclick="ord.export('.$p['id_compra'].',\'pdf\')" ><span style="color:#bb0706" class="fa fa-file-pdf-o"></span> Exportar PDF </a></li>		                     
		                    '.( $p['borrar'] ? '<li><a href="#" data-id_compra="'.$p['id_compra'].'" data-fn="nuevaOrden"><span class="fa fa-pencil"></span> Editar </a></li><li class="divider"></li><li><a href="#"  data-id_compra="'.$p['id_compra'].'" data-fn="borrarOrden"><span class="fa fa-eraser text-danger"></span> Borrar </a></li>':'' ).'
		                  </ul>
		     	</div>
	        </td></tr>';
	}
