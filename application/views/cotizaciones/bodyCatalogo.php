              	...
              	<div class="box-tools pull-right">		      
	                <div class="input-group input-group-sm" style="width: 500px;">
	                  ...
	                  <div class="input-group-btn box-filter-parent">
	                    ...
	                    <?php include_once FCPATH.'application/views/cotizaciones/filter.php';?>
                    	<button type="button" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" data-trigger="hover"  title="Nueva cotizacion" data-fn="nuevaCotizacion"><i class="fa fa-plus"></i></button>
                       </div>
	                </div> 
		    	</div>                         
            </div>
