<div class="modal fade" id="cot-modal" data-width="90%">
			...
			<div class="modal-body">
				<div class="row">
						...
						<table class="table table-condensed table-bcotered table-stripped fixed prd-form" id="prdCotTbl" style="opacity: 0">
							...
							<tfoot>
								<tr>
									...
									<div class="input-group">
										<div class="input-group-btn">
											<button type="button" class="btn btn-default" title="Nuevo Producto" >
												<i class="fa fa-plus"></i>
											</button>
											<button type="button" class="btn btn-default"   title="Lista de Productos">
									...
									<td>
									<input type="text" class="form-control typeahead" id="conc_cot" />
									</td>
									<td class="bold right" style="padding:6px!important;" id="existenciap"></td>
									<td >
									<div class="input-group">
										<input type="text" class="form-control number" id="cantidadp">
										<span class="input-group-btn"> <select class="form-control selectpicker" id="umc" name="umc" data-container="body" data-width="40px">
								...
								<tr>
									...
									<td  class="right bold"  id="subtotal"> $ 0.00 </td>
								</tr>
								<tr>
									<td colspan="9" class="right"> Descuento Gral: </td>
									<td  class="right bold" id="descuento"> $ 0.00 </td>
								</tr>
								<tr>
									<td colspan="9" class="right" > Gastos de envio: </td>
									<td  class="right bold" id="envio"> $ 0.00 </td>
								</tr>
								<tr>
									<td colspan="9" class="right"> Subtotal: </td>
									<td  class="right bold"  id="subtotal_descuento"> $ 0.00 </td>
								</tr>
								<tr>
									<td colspan="9" class="right" > I.V.A.: </td>
									<td  class="right bold" id="iva"> $ 0.00 </td>
								</tr>
								<tr>
									<td colspan="9" class="right"  > Total: </td>
									<td  class="right bold" id="total"> $ 0.00 </td>
								</tr>
							</tfoot>
						</table>
					</div>
					...
					<div class="form-group col-sm-12">
						...
						<textarea type="text" rows="" style="resize: none" class="form-control" id="condiciones" name="condiciones"></textarea>
					</div>
				</div>
			</div>
