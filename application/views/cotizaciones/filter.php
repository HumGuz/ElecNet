	...
	<form id="srch-cot" role="form">
		<div class="box-body box-body-filter row">
			...
			<div class="form-group col-sm-12">
				...
				<select  class="form-control selectpicker" id="id_cliente" name="id_cliente" data-container="body" data-live-search="true"  data-actions-box="true" multiple="multiple">
					<?php
					if (!empty($clt)) {
