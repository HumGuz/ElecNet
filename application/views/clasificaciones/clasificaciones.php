...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="glyphicon glyphicon-folder-open"></i>&nbsp;&nbsp;Clasificación de productos
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active"> Clasificación de productos</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">    
      <?php include_once FCPATH.'application/views/clasificaciones/bodyCatalogo.php';?> 
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
  ...
  <script>app.script('cls','init')</script>
</div>
<!-- ./wrapper -->
</body>
</html>
