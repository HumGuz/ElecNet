					...
					<tr>
	                  ...
	                  <td width="30px" class="opt-td">
		                  ...
		                  <ul class="dropdown-menu pull-right" role="menu">
		                    ...
		                    <li><a href="#" data-id_cliente="'.$s['id_cliente'].'" data-fn="nuevoCliente"><span class="fa fa-pencil"></span> Editar </a></li>
		                    '.( $s['borrar'] ? '<li class="divider"></li><li><a href="#" data-id_cliente="'.$s['id_cliente'].'" data-fn="borrarCliente"><span class="fa fa-eraser text-danger"></span> Borrar </a></li>':'' ).'
		                  </ul>
		                </div>
	                  </td>
	                </tr> ';	$x++;		
