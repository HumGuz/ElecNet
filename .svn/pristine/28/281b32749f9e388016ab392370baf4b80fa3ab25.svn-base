...
<?php include_once FCPATH.'application/views/sitio/includes/nav.php';?>  
 ...
 <!-- deal_day  --> 
  <?php //include_once FCPATH.'application/views/sitio/includes/deal_day.php';?>  
  
 <!-- banner section --> 
  <?php //include_once FCPATH.'application/views/sitio/includes/banner.php';?>  
  
  <!-- Blog -->
 <?php //include_once FCPATH.'application/views/sitio/includes/blog_section.php';?>  
  
   <!-- Featured products -->
 <?php include_once FCPATH.'application/views/sitio/includes/featured.php';?>  
...
<!-- JS --> 
<?php include_once FCPATH.'application/views/sitio/includes/scripts.php';?>
